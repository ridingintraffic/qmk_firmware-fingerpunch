...
cp keyboards/xoiviox/ffkb/config-rgb-matrix-ec11.h keyboards/xoiviox/ffkb/config.h
cp keyboards/xoiviox/ffkb/rules-rgb-matrix-ec11.mk keyboards/xoiviox/ffkb/rules.mk
...
cp .build/xoiviox_ffkb_sadekbaroudi* /mnt/g/My\ Drive/qmk-keyboards/ffkb-rgb-matrix-ec11/
