...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAVIGATION] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______,  KC_TAB, KC_BSPC, LT(_MEDIA,KC_SPACE), KC_DOT, _______, _______, _______
    ),
    ...
    [_SYMBOLS] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______,(_MEDIA,KC_ENT), KC_TAB, KC_BSPC, _______, _______, _______, _______, _______
    ),
