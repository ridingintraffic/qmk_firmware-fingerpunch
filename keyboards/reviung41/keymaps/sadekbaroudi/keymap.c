...
#define LAYOUT_reviung41_base( \
  ...
  LAYOUT_wrapper( \
        ...
        KC_TAB,          LCTL_T(K11),    LGUI_T(K12),    LALT_T(K13),    LSFT_T(K14),        K15,                LT(_MOUSE, K16),    RSFT_T(K17),        RALT_T(K18),      RGUI_T(K19),    RCTL_T(K1A),     _______, \
        _______,         K21,            K22,            K23,            K24,                K25,                K26,                K27,                K28,              K29,            K2A,             _______, \
                                                KC_DEL,          LT(_NAVIGATION,KC_ENT),       LT(_FUNCTION,KC_BSPC),       LT(_SYMBOLS,KC_SPACE),     KC_QUOT  \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAVIGATION] = LAYOUT_wrapper(
        ...
        _______, ________________NAVIGATION_3_______________, _________________NUMPAD_3__________________, KC_DOT,
                                       _______, _______, KC_BSPC, LT(_MEDIA,KC_SPACE), KC_DOT
    ),
    ...
    [_SYMBOLS] = LAYOUT_wrapper(
        ...
        _______, ________________SYMBOLS_L3_________________, ________________SYMBOLS_R3_________________, _______,
                                    _______, LT(_MEDIA,KC_ENT), KC_BSPC, _______, _______
    ),
    ...
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        _______, ________________SHIFTNAV_3_________________, ________________FUNCTION_3_________________, _______,
                                       _______, _______, _______, N_DEL_LINE, KC_SPACE
    ),
