...
#define LAYOUT_reviung41_base( \
  ...
  LAYOUT_wrapper( \
        ...
        _______,         K21,            K22,            K23,            K24,                K25,                K26,                K27,                K28,              K29,            K2A,             _______, \
                                                                      K33, LT(_NAVIGATION,K34), LT(_FUNCTION,K35),   LT(_SYMBOLS,K36), K37 \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_ALPHA_ALT] = LAYOUT_reviung41_base_wrapper(
        ...
        _________________ALPHA_ALT_L3_________________, _________________ALPHA_ALT_R3_________________,
                                              __ALPHA_ALT_THUMBS_5__
    ),

    [_ALPHA] = LAYOUT_reviung41_base_wrapper(
