...
/*
 * The `LAYOUT_adux_base` macro is a template to allow the use of identical
...
#define LAYOUT_adux_base( \
  ...
  LAYOUT_wrapper( \
        ...
        K21,             K22,            K23,            K24,                 K25,            K26,                 K27,                K28,              K29,            K2A, \
                                              LT(_NAVIGATION,K34), LT(_FUNCTION,K35),    LT(_MEDIA,K36), LT(_SYMBOLS,K37) \
    )

/* Re-pass though to allow templates to be used */
#define LAYOUT_adux_base_wrapper(...)       LAYOUT_adux_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_adux_base_wrapper(
        ...
        _________________ALPHA_ALT_L3_________________, _________________ALPHA_ALT_R3_________________,
                                             __ALPHA_ALT_THUMBS_4__
    ),

    [_ALPHA] = LAYOUT_adux_base_wrapper(
    ...
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        ________________SHIFTNAV_3_________________, ________________FUNCTION_3_________________,
                                   _______, _______, N_DEL_LINE, KC_SPACE
    ),
    ...
    [_MOUSE] = LAYOUT_wrapper(
        ...
        __________________MOUSE_3__________________, ___________________BLANK___________________,
                             KC_MS_BTN1, KC_MS_BTN3, KC_MS_BTN3, KC_MS_BTN2
    ),
