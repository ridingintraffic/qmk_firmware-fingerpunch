...
#define LAYOUT_ffkbhw_base( \
  ...
  LAYOUT_wrapper( \
        ...
        K21,             K22,            K23,            K24,                K25,    K26,                K27,                K28,              K29,            K2A, \
                   KC_MUTE, KC_DEL, LT(_NAVIGATION,KC_ENT), LT(_FUNCTION,KC_TAB),    LT(_FUNCTION,KC_BSPC), LT(_SYMBOLS,KC_SPACE), KC_QUOT, LCTL(KC_DEL) \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_ffkbhw_base_wrapper(
        _________________QWERTY_L1_________________, _________________QWERTY_R1_________________,
        _________________QWERTY_L2_________________, _________________QWERTY_R2_________________,
        _________________QWERTY_L3_________________, _________________QWERTY_R3_________________
    ),

    [_COLEMAK] = LAYOUT_ffkbhw_base_wrapper(
        ______________COLEMAK_MOD_DH_L1____________, ______________COLEMAK_MOD_DH_R1____________,
        ______________COLEMAK_MOD_DH_L2____________, ______________COLEMAK_MOD_DH_R2____________,
        ______________COLEMAK_MOD_DH_L3____________, ______________COLEMAK_MOD_DH_R3____________
    ),

    [_WORKMAN] = LAYOUT_ffkbhw_base_wrapper(
    ...
    [_SYMBOLS] = LAYOUT_wrapper(
        ...
        _______, _______, LT(_MEDIA,KC_ENT), KC_DEL, KC_BSPC, _______, _______, _______
    ),
