...
#define LAYOUT_reviung39_base( \
  ...
  LAYOUT_wrapper( \
        ...
        KC_TAB,          LCTL_T(K11),    LGUI_T(K12),    LALT_T(K13),    LSFT_T(K14),    K15,                K16,            RSFT_T(K17),    RALT_T(K18),      RGUI_T(K19),    RCTL_T(K1A),     KC_QUOT, \
        KC_DEL,          LSFT_T(K21),    K22,            K23,            K24,            K25,                K26,            K27,            K28,              K29,            LT(_MOUSE, K2A), KC_RSFT, \
